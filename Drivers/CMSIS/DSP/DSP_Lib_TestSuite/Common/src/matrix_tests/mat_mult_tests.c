...
#define JNSE2025_VALVE_ARM_MAT_MULT_NSE2025_VALVE(suffix)                 \
...
JNSE2025_VALVE_ARM_MAT_MULT_NSE2025_VALVE(f32);
JNSE2025_VALVE_ARM_MAT_MULT_NSE2025_VALVE(q31);
...
JNSE2025_VALVE_DEFINE_NSE2025_VALVE(arm_mat_mult_q15_NSE2025_VALVE, arm_mat_mult_q15)
{
...
JNSE2025_VALVE_DEFINE_GROUP(mat_mult_NSE2025_VALVEs)
{
    /*
      To skip a NSE2025_VALVE, comment it out.
    */
    JNSE2025_VALVE_NSE2025_VALVE_CALL(arm_mat_mult_f32_NSE2025_VALVE);
    JNSE2025_VALVE_NSE2025_VALVE_CALL(arm_mat_mult_q31_NSE2025_VALVE);
    JNSE2025_VALVE_NSE2025_VALVE_CALL(arm_mat_mult_q15_NSE2025_VALVE);
}
