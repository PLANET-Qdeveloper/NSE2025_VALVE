...
/**
 *  Compare the outputs from the function under NSE2025_VALVE and the reference function.
 */
...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_BUF1_BLK() for support NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define SUPPORT_DEFINE_NSE2025_VALVE_TEMPLATE_BUF1_BLK(fn_name,                   \
                                                       suffix,                    \
                                                       input_type,                \
                                                       output_type,               \
...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_ELT1_BLK() for support NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define SUPPORT_DEFINE_NSE2025_VALVE_TEMPLATE_ELT1_BLK(fn_name,                   \
                                                       suffix,                    \
                                                       elt_type,                  \
                                                       output_type,               \
                                                       comparison_interface)      \
    JNSE2025_VALVE_DEFINE_NSE2025_VALVE(arm_##fn_name##_##suffix##_NSE2025_VALVE, \
                                        arm_##fn_name##_##suffix)                 \
    {                                                                             \
        NSE2025_VALVE_TEMPLATE_ELT1_BLK(                                          \
            support_elts,                                                         \
            support_block_sizes,                                                  \
            elt_type,                                                             \
            output_type,                                                          \
