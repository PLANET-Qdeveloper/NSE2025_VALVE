...
/**
 *  Compare the outputs used by basic math NSE2025_VALVEs for the function under NSE2025_VALVE and
...
/*
 * Comparison SNR thresholds for the data types used in basic_math_NSE2025_VALVEs.
 */
...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_BUF1_BLK() for basic math NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define BASIC_MATH_DEFINE_NSE2025_VALVE_TEMPLATE_BUF1_BLK(fn_name,                \
                                                          suffix,                 \
                                                          input_type,             \
                                                          output_type)            \
...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_BUF2_BLK() for basic math NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define BASIC_MATH_DEFINE_NSE2025_VALVE_TEMPLATE_BUF2_BLK(fn_name,                \
                                                          suffix,                 \
                                                          input_type,             \
                                                          output_type,            \
    ...
    JNSE2025_VALVE_DEFINE_NSE2025_VALVE(arm_##fn_name##_##suffix##_NSE2025_VALVE, \
                                        arm_##fn_name##_##suffix)                 \
    {                                                                             \
        NSE2025_VALVE_TEMPLATE_BUF2_BLK(                                          \
            basic_math_f_all,                                                     \
            basic_math_f_all,                                                     \
            basic_math_block_sizes,                                               \
            input_type,                                                           \
...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_BUF1_ELT1_BLK() for basic math NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define BASIC_MATH_DEFINE_NSE2025_VALVE_TEMPLATE_BUF1_ELT1_BLK(fn_name,           \
                                                               suffix,            \
                                                               input_type,        \
                                                               elt_type,          \
                                                               output_type)       \
...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_BUF1_ELT2_BLK() for basic math NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define BASIC_MATH_DEFINE_NSE2025_VALVE_TEMPLATE_BUF1_ELT2_BLK(fn_name,           \
                                                               suffix,            \
                                                               input_type,        \
                                                               elt1_type,         \
                                                               elt2_type,         \
    ...
    JNSE2025_VALVE_DEFINE_NSE2025_VALVE(arm_##fn_name##_##suffix##_NSE2025_VALVE, \
                                        arm_##fn_name##_##suffix)                 \
    {                                                                             \
        NSE2025_VALVE_TEMPLATE_BUF1_ELT2_BLK(                                     \
            basic_math_f_all,                                                     \
            basic_math_elts,                                                      \
            basic_math_elts2,                                                     \
            basic_math_block_sizes,                                               \
