...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_BUF1_BLK() for statistics NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define STATISTICS_DEFINE_NSE2025_VALVE_TEMPLATE_BUF1_BLK(fn_name,                \
                                                          suffix,                 \
                                                          input_type,             \
                                                          output_type,            \
