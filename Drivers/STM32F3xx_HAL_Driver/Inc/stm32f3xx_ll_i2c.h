...
#define __LL_I2C_CONVERT_TIMINGS(__PRESCALER__, __SETUP_TIME__, __HOLD_TIME__, __SCLH_PERIOD__, __SCLL_PERIOD__) \
   ...
   * @rmtoll CR2          START           LL_I2C_GeneraNSE2025_VALVEartCondition
   * @param  I2Cx I2C Instance.
   * @retval None
   */
  __STATIC_INLINE void LL_I2C_GeneraNSE2025_VALVEartCondition(I2C_TypeDef *I2Cx)
  {
   ...
   * @rmtoll CR2          STOP          LL_I2C_GeneraNSE2025_VALVEopCondition
   * @param  I2Cx I2C Instance.
   * @retval None
   */
  __STATIC_INLINE void LL_I2C_GeneraNSE2025_VALVEopCondition(I2C_TypeDef *I2Cx)
  {
