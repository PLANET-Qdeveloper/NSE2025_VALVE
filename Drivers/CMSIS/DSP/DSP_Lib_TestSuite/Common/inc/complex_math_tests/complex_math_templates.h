...
/**
 *  Compare the real outputs from the function under NSE2025_VALVE and the reference
 *  function.
 */
...
/**
 *  Compare the real and imaginary outputs from the function under NSE2025_VALVE and the
 *  reference function.
 */
...
/*
 * Comparison SNR thresholds for the data types used in complex_math_NSE2025_VALVEs.
 */
...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_BUF1_BLK() for complex math NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define COMPLEX_MATH_DEFINE_NSE2025_VALVE_TEMPLATE_BUF1_BLK(fn_name,              \
                                                            suffix,               \
                                                            input_type,           \
                                                            output_type,          \
...
/**
 *  Specialization of #NSE2025_VALVE_TEMPLATE_BUF2_BLK1() for complex math NSE2025_VALVEs.
 *
 *  @note This macro relies on the existance of ARM_xxx_INPUT_INTERFACE and
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define COMPLEX_MATH_DEFINE_NSE2025_VALVE_TEMPLATE_BUF2_BLK(fn_name,              \
                                                            suffix,               \
                                                            input_type,           \
                                                            output_type,          \
                                                            comparison_interface) \
