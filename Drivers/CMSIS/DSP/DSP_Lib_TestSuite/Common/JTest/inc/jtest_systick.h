#ifndef _JNSE2025_VALVE_SYSTICK_H_
#define _JNSE2025_VALVE_SYSTICK_H_
 ...
 *  counter.
 */
#define JNSE2025_VALVE_SYSTICK_INITIAL_VALUE 0xFFFFFF
 ...
 *  counting.
 */
#define JNSE2025_VALVE_SYSTICK_RESET(systick_ptr)               \
  do                                                            \
  {                                                             \
    (systick_ptr)->LOAD = JNSE2025_VALVE_SYSTICK_INITIAL_VALUE; \
    (systick_ptr)->VAL = 1;                                     \
                                                                \
 ...
 */
#define JNSE2025_VALVE_SYSTICK_START(systick_ptr)     \
  do                                                  \
  {                                                   \
    (systick_ptr)->CTRL =                             \
 ...
 */
#define JNSE2025_VALVE_SYSTICK_VALUE(systick_ptr) \
  ((systick_ptr)->VAL)

#endif /* _JNSE2025_VALVE_SYSTICK_H_ */
